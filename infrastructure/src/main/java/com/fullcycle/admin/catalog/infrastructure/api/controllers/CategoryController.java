...
import com.fullcycle.admin.catalog.infrastructure.category.presentes.CategoryApiPresenter;
...
public class CategoryController implements CategoryAPI {
    ...
    @Override
    public Pagination<CategoryListResponse> listCategories(final String search, final int page, final int perPage, final String sort, final String dir) {
